...
data_mean%>%ggplot(aes(x=union,y=lwage))+geom_point()+stat_function(fun = function(x){pool1$coefficients[1]+pool1$coefficients[2]*x},color="black",linetype="dashed")
...
WAGE_data$lwage_demean
WAGE_data$union_demean
WAGE_data$educ.high_demean
