...
1. 引入WAGEPAN.rda這個資料。
```{r}
load("D:/r/YOULOVEME/WAGEPAN.rdata")
WAGEPAN
```
...
```{r, warning=FALSE}
fw <- plm(model1,data=WAGE_data, model ="within", effect ="individual")
rw <- plm(model1,data = WAGE_data, model = "random")
stargazer(fw,rw,type = "text")
```
