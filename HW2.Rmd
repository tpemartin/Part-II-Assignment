...
#觀察此兩個箱型圖可發現，加入工會的人其中位數、上四分位數、下四分位數比沒加入工會的人還來得高，且分布更為集中。但最大值變小，最小值變大，個人認為工會確實可以為弱勢族群爭取權益，因此能夠提高最小工資；但參加工會會產生所謂的協商議價成本，導致無法提高最高工資。即工作能力強者可能會選擇不加入工會，獨自與雇主進行協商，欲達到更高的薪資。
```
