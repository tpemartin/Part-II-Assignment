...
### 從圖中可以明顯的看出，加入工會的人的工資分佈相對來說更窄，更為集中在中位數附近（四分位距變窄），且其最小值、中位數、上四分位數、下四分位數比沒加入工會的有明顯的提高，但最大值變小，看起來工會有降低高工資，提高低工資，並且使工資分佈更為集中的效果。
```
...
## 薪資會受到來自教育年限和工會狀態有相關性，平均來看，其他條件不變下，教育年限越高，平均薪資越高（教育提高了人力資本）；加入工會的平均薪資比沒加入高（工會作為一個勞方阻止，提高了工薪階層與資方的議價能力）。並且，教育對於薪資的增加幅度會大於工會，顯示提高人力資本比靠工會議價來的有效。
```
...
#＃教育年限是一個重要的解釋變數，它會影響薪資，也會影響一個人是否加入工會的決定。如我們之前箱形圖看到的，加入工會的工資雖然會提高，但會更集中在平均值附近，而且接受高等教育提升人力資本，比加入工會來的更好更有效，較高學歷者對於加入工會的意願就沒那麼高。
```
...
##  邏輯型變數無法demean，但是就算是轉化為數值型，仍無法demean，因此後面用educ demean 沒用educ_high demean
